      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-3 mb-4">
            <div className="w-12 h-12 bg-gray-600 rounded-2xl flex items-center justify-center shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
              ...
              <select
                ...
                className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500 bg-white text-gray-800 font-medium shadow-sm hover:shadow-md transition-all duration-200"
                required
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                ...
                <div className="flex justify-between items-center mt-2">
                  <p className="text-xs text-gray-600 font-medium">생생한 제목으로 관심을 끌어보세요</p>
              ...
              <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                ...
                />
                <div className="flex justify-between items-center mt-2">
                  <p className="text-xs text-gray-600 font-medium">익명으로 안전하게 소통하세요</p>
            ...
            <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
              ...
              />
              <div className="flex justify-between items-center mt-2">
                <p className="text-xs text-gray-600 font-medium">🔒 글 수정/삭제 시 필요한 비밀번호입니다</p>
...
• 경험담이나 조언이 있으시면 공유해주세요"
                rows={12}
                className="w-full px-4 py-4 border-2 border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500 bg-white text-gray-800 font-medium shadow-sm hover:shadow-md transition-all duration-200 resize-none leading-relaxed"
                required
                maxLength={2000}
              />
              <div className="flex justify-between items-center mt-3">
                <p className="text-xs text-gray-600 font-medium">💝 따뜻한 마음으로 고민을 나눠주세요</p>
            ...
            <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center bg-white hover:bg-gray-50 transition-all duration-200 hover:border-gray-400">
                <input
                  type="file"
                  multiple
                  accept="image/*"
                ...
                <label htmlFor="image-upload" className="cursor-pointer">
                  <div className="flex flex-col items-center">
                    ...
                    <div className="text-sm text-gray-600 font-medium">📸 최대 5개, 각 5MB 이하</div>
                      ...
                      {imagePreview.map((preview, index) => (
                        <div key={index} className="relative group">
                          <img
                            src={preview}
                            alt={`첨부 이미지 ${index + 1}`}
                            className="w-full h-24 object-cover rounded-lg border-2 border-gray-300 shadow-sm group-hover:shadow-md transition-all duration-200"
                          />
                          <button
                            type="button"
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-4 mt-8 pt-6 border-t border-gray-200">
              ...
              <button
                ...
                className="group px-10 py-4 bg-gray-700 hover:bg-gray-800 disabled:bg-gray-400 text-white rounded-xl font-bold text-lg transition-all duration-200 shadow-lg hover:shadow-xl disabled:shadow-sm disabled:cursor-not-allowed flex items-center justify-center gap-3 transform hover:scale-105 disabled:scale-100"
              >
                {isSubmitting ? (
                  <>
        ...
        <div className="mt-8 bg-gray-50 rounded-xl p-6 border border-gray-200 shadow-sm">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="text-lg font-bold text-gray-800">🔒 개인정보 보호 안내</div>
          </div>
          <div className="bg-white rounded-lg p-4 border border-gray-200">
            <p className="text-sm text-gray-700 leading-relaxed">
              <strong className="text-gray-700">🛡️ 안전한 소통을 위해:</strong> 업로드된 이미지에는 개인정보가 포함되지 않도록 주의해주세요. 
